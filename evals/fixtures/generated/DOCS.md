...
## 1. Map
- `docs/design/fieldnote-design.md` — what Fieldnote is and its success criteria
- `docs/design/api-surface.md` — the public surface and error model
...
## 3. Reading order
New to the project: `README.md`, then `docs/design/fieldnote-design.md`, then `docs/design/api-surface.md`. Starting a session: `AGENTS.md`, then `docs/CURRENT.md`, then your plan. Making a design change: the design doc, then `docs/decisions/AGENTS.md`.
