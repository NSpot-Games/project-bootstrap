...
| `<project>/docs/design/architecture.md` | pipeline stages (ingest, train, evaluate, serve); the key interfaces as code; data flow with a latency and throughput budget; persistence (artifacts, checkpoints); testing strategy | bootstrap |
