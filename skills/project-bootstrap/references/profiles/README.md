...
An outline in section 2 lists what is specific to the doc. Whatever it lists, every design doc also ends with the Decisions section and the open-questions pointer that `references/core/doc-kinds.md §3` requires, and the profile's example instance carries a README with a numbered *Gaps* section (`SKILL.md §3`).
