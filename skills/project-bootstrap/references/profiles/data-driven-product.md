...
| `<project>/docs/design/architecture.md` | repo layout (packages, apps, backend); one line per module; the key interfaces as code; data flow for the main operation with a latency budget; persistence; offline and failure behaviour; testing strategy; security | bootstrap |
